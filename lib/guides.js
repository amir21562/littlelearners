...
const PILLARS = [
  ...
  },
  {
    ...
    icon: "🎨",
    desc: "Colouring, games and joyful hands-on practice — the playful side of learning for ages 3–6.",
  },
];
...
const GUIDES = [
  ...
  {
    slug: "blending-cvc-words",
    pillar: "phonics",
    title: "Blending CVC Words",
    summary:
      "Help your child blend CVC words like cat and pin: pure sounds, the slow-then-fast technique, 30 starter words, blending games and guessing fixes.",
    minutes: 8,
    products: ["phonics-phase-2"],
    answer:
      "Blending is pushing letter sounds together to read a word: c-a-t becomes 'cat'. Start once your child knows most Phase 2 sounds. Say each sound purely ('c-a-t', not 'cuh-ah-tuh'), run the sounds into each other, then say the whole word fast. Five to ten minutes a day is plenty — it usually clicks within weeks.",
    sections: [
      {
        h: "Blending, in plain English",
        body: [
          "Blending is the moment phonics turns into reading. It means pushing individual letter sounds together to make a word: your child sees c-a-t, says each sound, then joins them into 'cat'. Every word they will ever read — from 'dog' to 'extraordinary' — is read this way.",
          "It is worth knowing the word because schools use it constantly. 'Sound it out' and 'blend it' mean the same thing. The reverse — pulling a word apart into its sounds, like 'cat' into c-a-t — is called segmenting, and it is how children learn to spell. The two skills grow together.",
          "The good news: blending is a small, teachable skill, not a talent. Most children get it within weeks of starting, and you can practise it at the kitchen table with nothing but your voice.",
        ],
      },
      {
        h: "First, the sounds must be pure",
        body: [
          "Blending only works if the sounds going in are clean. If your child says 'cuh-ah-tuh', no amount of pushing will make 'cat' — the extra 'uh' sounds get in the way. This is the single biggest reason blending stalls at home.",
          "Stretchy sounds should stretch: sss, mmm, nnn, fff, lll, rrr. Bouncy sounds should be short and crisp: c, t, p, d, g — tiny taps, never 'cuh' or 'tuh'. Short vowels stay short: a as in apple, e as in egg, i as in insect, o as in orange, u as in umbrella.",
          "Do not drill this separately for long. Practise pure sounds inside blending itself: every time you model c-a-t turning into 'cat', you are teaching both skills at once.",
        ],
      },
      {
        h: "'Say it slowly, then say it fast'",
        body: [
          "This is the whole technique, and it is all you need: say the sounds slowly and robotically, then say the complete word fast and naturally. Model it like this, sweeping your finger under the letters as you go: 'c… a… t… (pause)… cat!'",
          "Two small tricks make it work. First, do not leave gaps between the sounds — run them into each other like a slide: 'cccaaatt' rather than 'c. a. t.' Words built from stretchy sounds (s, m, n, f, l, r) make this easy, so start with those. Second, always finish with the fast, natural word, said with a smile — that is the reward the brain remembers.",
          "Take turns: you do the slow robot part, your child does the fast word. Then swap roles. Within days, most children start doing both halves themselves.",
        ],
      },
      {
        h: "30 words to start with",
        body: [
          "Start with words made of sounds your child already knows, and keep the vowels short. Grouping by vowel makes the pattern obvious — read one group a few times across a week before moving on.",
        ],
        list: [
          "a-words: cat, sat, mat, pat, tap, pan, map, bag, hat, ran",
          "e-words: pen, hen, ten, pet, red, bed",
          "i-words: pin, bin, sit, pit, pig, fin",
          "o-words: dog, log, pot, mop, cot",
          "u-words: cup, bus, sun, run, mud",
        ],
      },
      {
        h: "Five games that make blending stick",
        body: [
          "Blending practised as a game beats blending practised as a worksheet, every time. Five minutes of any of these counts as a full session.",
        ],
        list: [
          "Robot talk: speak in robot sounds at breakfast ('pass the m-i-l-k') and let them blend it back. They will beg for more.",
          "Mystery bag: put toy animals in a bag, pull one out and sound out its name — 'd-o-g!' — before they guess which one it is.",
          "Word hop: write CVC words on paper plates on the floor; they hop to the word you sound out.",
          "Silly sentences: 'The cat sat on the… m-a-t!' — pause and let them finish it.",
          "Shopping list: write a CVC shopping list (jam, ham, bun, egg) and 'read' it together at the shops.",
          "End every game the second the fun dips. Five happy minutes beats twenty tired ones.",
        ],
      },
      {
        h: "When they guess instead of blending",
        body: [
          "Most children go through a guessing phase: they see the first letter and the picture and announce a word. It is actually a clever strategy — just the wrong one for learning to read.",
          "Do not scold it; redirect it. Cover the picture with your thumb and say, 'Let's check with the sounds.' Model the blend once, then let them try. When the blended word matches the picture, point that out: 'See? The sounds told us!'",
          "If guessing is constant, the words may simply be too hard. Drop back to sounds they know cold and build up again — confidence is the fuel here.",
        ],
      },
      {
        h: "When it clicks — and when to ask the teacher",
        body: [
          "Blending often clicks suddenly: weeks of robot talk, then one day they just read the word. That leap is normal. After it, keep practising — fluency, reading smoothly without the robot voice, takes months of easy, enjoyable reading.",
          "Every child has their own timeline, but mention it to the teacher if: after several months of Reception your child still cannot hold three sounds in memory; they consistently cannot hear the sounds in spoken words (rhyming games and silly sound play help here); or reading is becoming upsetting. Teachers see this every year and will know exactly what to do.",
          "If you'd like the words as print-and-go cards — every Phase 2 sound with blending words matched to the teaching sets — our Phase 2 phonics pack has them ready to print.",
        ],
      },
    ],
    faqs: [
      [
        ...
        "Consonant-vowel-consonant: three sounds in three letters, like cat, pin and dog. They are the first words children read because each letter makes its usual sound — no tricks. A few short words that look simple but are not decodable, like 'the', come later as tricky words.",
      ],
      [
        "When should my child start blending?",
        "Once they know most of the Phase 2 sounds — usually during the autumn or spring of Reception. Schools start blending within weeks of teaching the first sounds. There is no prize for starting earlier; knowing the sounds securely matters more than rushing ahead.",
      ],
      [
        "My child can say the sounds but can't join them — help?",
        "This is the most common sticking point. Shorten the gaps between sounds until they run together ('cccaaat' instead of 'c… a… t'), and always model the fast word at the end. Start with stretchy-sound words like 'sun' and 'man', which are physically easier to slide together.",
      ],
      [
        "How long should we practise each day?",
        "Five to ten minutes, little and often. Two short sessions beat one long one, and stopping while it is still fun keeps them willing to come back tomorrow.",
      ],
      [
        "Letter names or letter sounds for blending?",
        "Sounds, always, for blending: 'c-a-t', never 'cee-ay-tee'. Letter names are useful later for spelling aloud and reciting the alphabet, but they get in the way of reading.",
      ],
      [
        "My child reads a word, then forgets it on the next page — is that normal?",
        "Completely. Early reading lives in short-term memory; words become automatic only after many encounters. Re-reading favourite books is the mechanism, not a failure — repetition is literally how the brain files words away.",
      ],
    ],
  },
  {
    slug: "benefits-of-colouring-children",
    pillar: "play-based-learning",
    title: "Benefits of Colouring for Children",
    summary:
      "Is colouring good for preschoolers? Nine real benefits — fine motor skills, focus, colour words, calm-down time — plus the honest limits and tips.",
    minutes: 8,
    products: ["mini-colouring-pack"],
    answer:
      "Colouring builds hand strength for writing, practises focus, teaches colour vocabulary and gives children creative control with no wrong answers. It is also a genuine calm-down activity. Its honest limit: it does not teach letter formation — that needs specific tracing practice. Ten to twenty minutes a day is plenty.",
    sections: [
      {
        h: "It builds the hand strength writing needs",
        body: [
          "This is the big one. Gripping a crayon and controlling it across a page works the small muscles of the hand and fingers — the same muscles that will later hold a pencil for writing. Every colouring session is quiet strength training.",
          "It also builds the tripod grip (thumb and two fingers) naturally, especially with short, chunky crayons that cannot be grabbed in a fist. Teachers call this pre-writing work, and it genuinely makes letter formation easier when that stage arrives.",
          "You will see the grip evolve if you watch over months: first the whole fist, then fingers pointing down the crayon, then the mature tripod hold. Each stage is normal — the crayon itself teaches the hand, which is why short crayons beat long ones. A stubby crayon simply cannot be held any way except with fingertips.",
        ],
      },
      {
        h: "Focus, one crayon at a time",
        body: [
          "A colouring page gives a young child something rare: a task with a visible finish line. Choosing colours, staying roughly inside an area, deciding what comes next — all of it practises sustained attention in a way that open-ended play sometimes does not.",
          "Ten focused minutes with crayons is ten minutes of concentration practice. For a 4-year-old, that is a meaningful workout, and it transfers to puzzles, books and classroom listening.",
          "Finishing matters too. A colouring page is one of the first tasks a child can complete entirely on their own, and that experience of sticking with something until it is done builds persistence. Praise the finishing, not just the result: 'You kept going until every part was coloured — that's real sticking power.'",
        ],
      },
      {
        h: "Colour names and colour sense",
        body: [
          "Colouring is where most children lock in their colour vocabulary — not just red and blue, but turquoise, peach, and 'dark green versus light green'. Naming colours as they pick them up turns a quiet activity into a language activity.",
          "It also teaches early observation: grass is green but the sky is blue — and a purple sun is allowed too. Both lessons matter.",
        ],
      },
      {
        h: "Creativity with no wrong answers",
        body: [
          "A colouring page is a gentle kind of creativity: structured enough not to be intimidating, open enough for real choices. Which colours? Patterns or solid fills? A blue dog? Every decision is theirs.",
          "There is no wrong answer, which makes colouring one of the first activities where a child experiences genuine creative control — and the pride of finishing something that is entirely their own work.",
        ],
      },
      {
        h: "The calm-down effect",
        body: [
          "Ask any parent: crayons are a reset button. The repetitive motion, the quiet focus, the absence of decisions that matter — it settles busy minds. Many families use colouring as the bridge between energetic play and calmer activities like dinner or bedtime stories.",
          "It works for grown-ups too, which is why colouring together can become a genuinely peaceful shared ritual rather than just an activity you supervise from the sofa.",
          "Many parents build it into the daily rhythm deliberately: twenty minutes of colouring after nursery while dinner cooks, or one page together before bed instead of a second story. Because it is screen-free and self-paced, it does not wire them up the way a cartoon before bed can. If the afternoons in your house tend to fray at the edges, try putting the crayon tin where the chaos usually starts.",
        ],
      },
      {
        h: "Sneaky early maths",
        body: [
          "Colouring pages quietly smuggle in maths: counting how many stars need colouring, making AB patterns (red, blue, red, blue), noticing the symmetry in a butterfly's wings, comparing bigger and smaller areas.",
          "You do not need to teach any of it formally. 'Can you colour every other stripe?' is a pattern lesson wearing a crayon costume.",
          "There is spatial thinking in there as well: planning which area to colour first, judging whether the blue will fit inside the whale, rotating the page to reach a corner. These are the same mental skills that later help with geometry, maps and even handwriting layout on a page.",
        ],
      },
      {
        h: "The honest limit: colouring won't teach letter formation",
        body: [
          "Here is the honest bit. Colouring builds hand strength and control, but it does not teach a child how to form letters — that needs specific practice with starting points and stroke directions, the way schools teach it.",
          "Think of colouring as the gym and letter formation as the sport. The gym makes the sport easier, but it does not replace practice. When your child is ready for letters, tracing pages with proper formation take over from there.",
        ],
      },
      {
        h: "Making colouring time richer",
        body: [
          "A few small habits multiply what colouring gives back. Start with the setup: a low table or floor space they can reach alone, crayons in an open tin rather than a zipped case, and paper they are allowed to take freely. When children can start colouring without asking permission, they do it far more often — and frequency is where the benefits compound.",
        ],
        list: [
          "Narrate the colours: 'You've chosen emerald green for the leaves — great choice.' Vocabulary grows in these throwaway moments.",
          "Play stay-in-the-lines games — not as a rule, but as a challenge: 'Can you keep the blue inside the whale?' Control follows motivation.",
          "Colour together, side by side. Children absorb grip, patience and care from watching you.",
          "Display the finished work. A fridge gallery tells them their effort matters.",
          "If you'd like fresh pages to colour — friendly pictures sized for little hands, ready to print as often as you like — our mini colouring pack has them.",
        ],
      },
    ],
    faqs: [
      [
        "At what age can my child start colouring?",
        "Most children start scribbling around 18 months and colour with some purpose between 3 and 4. Offer chunky crayons early; precision arrives on its own schedule and cannot be rushed.",
      ],
      [
        "Does it matter if they stay inside the lines?",
        "Not at first. Scribbling is a developmental stage, not a mistake. Line control typically firms up between 4 and 5 — before that, enthusiasm matters more than accuracy.",
      ],
      [
        "Crayons, felt tips or colouring pencils — which is best?",
        "Chunky crayons first: they build the tripod grip and do not snap under pressure. Felt tips are satisfying but bleed through paper; pencils need more pressure than little hands enjoy. Offer all three eventually and let preference lead.",
      ],
      [
        "How long should a colouring session last?",
        "Follow the child. Ten to twenty minutes is typical at 4; some children will happily go longer. Stop while it is still enjoyable — a child who chooses to come back tomorrow is learning more than one who is made to finish.",
      ],
      [
        "Is colouring actually learning, or just keeping them busy?",
        "Both, and that is fine. The fine-motor work, focus practice and colour vocabulary are real developmental gains — and peacefully keeping them busy is a legitimate parenting win too.",
      ],
      [
        "My child colours everything one colour — should I worry?",
        "Not at all. A 'blue period' is normal and often just efficiency: one crayon, no decisions. Offer new colours casually — 'want to try the orange for the sun?' — without turning it into a lesson.",
      ],
    ],
  },
];
