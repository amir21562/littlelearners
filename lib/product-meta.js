...
const META = {
  ...
  "ultimate-bundle": {
    subject: "Bundle", ages: "3–6", ageGroups: ["3–4", "4–5", "5–6"], pages: 154,
    whats_inside: [
      "All 12 printable packs in one download — 154 pages",
      "Alphabet tracing, numbers to 20, Phase 2 phonics, Phase 3 phonics, tricky words, early addition, scissor skills, shapes, colouring, dot marker fun, Halloween and Christmas fun packs",
    ...
    how_to_use: [
      "Don't print all 154 pages at once — print what your child needs this month.",
