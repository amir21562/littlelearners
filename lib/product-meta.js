...
const META = {
  ...
  "ultimate-bundle": {
    subject: "Bundle", ages: "3–6", ageGroups: ["3–4", "4–5", "5–6"], pages: 128,
    whats_inside: [
      "All 10 printable packs in one download — 128 pages",
      "Alphabet tracing, numbers to 20, Phase 2 phonics, Phase 3 phonics, tricky words, early addition, scissor skills, shapes, colouring and the Halloween fun pack",
    ...
    how_to_use: [
      "Don't print all 128 pages at once — print what your child needs this month.",
