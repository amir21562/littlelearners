...
const SUPPORT_EMAIL = "hello@littlelearners.store";
...
<nav class="secnav">
<a href="#overview">Overview</a><a href="#inside">What's inside</a><a href="#details">Details</a><a href="#related">You may also like</a>
</nav>
...
<h1>${esc(g.title)}</h1>
<p class="gmeta">${g.minutes} min read · Written for UK parents · No subscription, no fluff</p>
...
const LEGAL = {
  privacy: {
    ...
    sections: [
      ...
      ["Your rights", "Under UK GDPR you can ask for a copy of your data, corrections, or deletion (where tax law allows). Email hello@littlelearners.store and we'll respond within 30 days."],
    ],
  },
  terms: {
  ...
  refunds: {
    ...
    sections: [
      ["Our 14-day promise", "If a file is corrupted, incomplete, or simply not as described on its product page, email hello@littlelearners.store within 14 days of purchase with your order number. We'll fix the file or refund you in full — your choice."],
